...
class MiniCourt():
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self, player_boxes, ball_boxes, original_court_key_points):
        ...
        default_player_height = 1.75  # Default height in meters, change as appropriate
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            # Use the get method to avoid KeyError and provide a default height if the ID is not in the dictionary
